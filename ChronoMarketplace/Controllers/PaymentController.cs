...
namespace ChronoMarketplace.Controllers
{
    public class PaymentController : Controller
    {
        ...
        public PaymentController(ChronoMarketplaceDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Payment != null ? 
                          ...
                          Problem("Entity set 'ChronoMarketplaceDbContext.Payment'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Payment_ID,Customer_ID,Pay_amount,Pay_method,Pay_date")] Payment payment)
        {
